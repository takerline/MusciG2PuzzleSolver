...
class RobotController:
    def __init__(self):
        ...
        ### POSE CORRESPONDIENTE AL ARUCO.
        self.pose_inicial = Pose()
        self.pose_inicial.position.x =-0.13640157580292084
        self.pose_inicial.position.y =0.21554719833597674
        self.pose_inicial.position.z = 0.24737362106327992

        self.pose_inicial.orientation.x = -0.9999799592303984
        self.pose_inicial.orientation.y =  0.006330822352999379
        self.pose_inicial.orientation.z =-1.9660482108045927e-05
        self.pose_inicial.orientation.w =3.793904699226883e-05
        ###
...
#             self.control.move_motors(self.initial_configuration)
#             self.pose_inicial = self.control.get_pose()
#             print("POSE inicial: ",self.pose_inicial)
#             input("Hola")
#             rospy.loginfo(f"Moviendo a configuración inicial.")
#         # Conf para tomar imágenes.
#         elif order == 'Photo':
