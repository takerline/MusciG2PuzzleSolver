...
if __name__ == '__main__':
    ...
    #control.move_motors(t2_1)
    # input("Hola")
    # angles = control.get_motor_angles()
    # print(angles)
    # input("Hola 2")
    
    # home = control.get_pose()

    #movements = [[0, 2, 0, 5, 1], [0, 1, 1, 5, 2], [2, 1, 4, 4, 1], [0, 2, 2, 5, 3], [1, 0, 3, 3, 1], [1, 2, 4, 4, 2], [0, 2, 2, 3, 1], [0, 1, 3, 5, 4], [2, 1, 2, 4, 1], [2, 0, 3, 4, 2], [1, 0, 3, 3, 1], [2, 1, 4, 4, 3], [0, 2, 2, 5, 1], [0, 1, 3, 3, 2], [2, 1, 4, 2, 1], [0, 2, 4, 5, 5], [1, 0, 1, 5, 1], [1, 2, 2, 4, 2], [0, 2, 4, 3, 1], [1, 0, 3, 5, 3], [2, 1, 2, 4, 1], [2, 0, 3, 4, 2], [1, 0, 3, 3, 1], [1, 2, 4, 4, 4], [0, 2, 2, 3, 1], [0, 1, 3, 5, 2], [2, 1, 2, 4, 1], [0, 2, 4, 3, 3], [1, 0, 3, 5, 1], [1, 2, 4, 2, 2], [0, 2, 4, 1, 1]]
