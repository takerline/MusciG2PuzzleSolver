    ...
    def cut_columns(self, columns: np.ndarray, img: np.ndarray, delta: int) -> dict:
        ...
        for l, pt in enumerate(grouped_columns):
            ...
            if r != -1:
                ...
                print("Detecto una columna faltante")
...
#     def detect_square(self, edged: np.ndarray, blur: np.ndarray, delta: int):
#         """
#         Detecta un cuadrado en la imagen que contiene círculos (las torres de Hanoi).
...
# if __name__ == '__main__':    
#     # Directorio que contiene las imágenes
#     image_directory = 'imagenes_5_dic_lab'
#     #image_directory = 'cam'
...
#         begin = time.time()
#         _, detenction, _, img= detect_hanoi.main(path_img)
#         end = time.time()
#         print(f"Tiempo de procesamiento: {end - begin} segundos")
