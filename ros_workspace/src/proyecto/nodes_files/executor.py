...
from proyecto.final.driver import hanois, larreaUtils
from proyecto.final.tools.location_circles_2 import DetectHanoiTower
...
from copy import deepcopy
from std_msgs.msg import String
from proyecto.final.driver import ControlRobot
...
if __name__ == '__main__':
    ...
    def callback_read_movements(self, data: Int32) -> None:
        """
    ...
    game_status = rospy.Publisher(
        'game_status', String, queue_size=10
    )
